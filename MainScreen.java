		...
		comboBox_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if("Save"==comboBox_5.getSelectedItem().toString()){
					//save = new currentPC(1,"TEST",pc.cpus.get(comboBox.getSelectedIndex()),pc.gpus.get(comboBox.getSelectedIndex()),
						//	pc.boards.get(comboBox.getSelectedIndex()),pc.memories.get(comboBox.getSelectedIndex()),
							//pc.powers.get(comboBox.getSelectedIndex()),pc.drives.get(comboBox.getSelectedIndex()));
					//pc.save(save, "TEST");
					save = new currentPC();
					pc.save(save,"TEST");
				...
				else if("Open Buid"==comboBox_5.getSelectedItem().toString()){
